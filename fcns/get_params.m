...
% %% color
% p.body_color    = [42 80 183]/255; % blue
% p.leg_color     = [7 179 128]/255; % green
% p.ground_color  = [195 232 243]/255; % teal

p.body_color    = [129 117 230]/255; % grey
p.leg_color     = [56 82 156]/255; % black
p.ground_color  = [219 219 219]/255; % yellow

...
%  %%%%%%%%% angular position %%%%%%%%%
    plot(h_x,t(1:ii),theta(1:ii,1),'r',...
         ...
         t(1:ii),thetad(1:ii,1),'r--',...
         t(1:ii),thetad(1:ii,2),'g--',...
...
%     set( get(h_x,'Title'), 'String', 'Position [m]');
    ...
    h_dx.XLim = [t(1) t(end)];
    legend(h_dx,'x','y','z', 'Location', 'northeastoutside');
    set( get(h_dx,'Title'), 'String', 'Velocity [m/s]');
    %set( get(h_dx,'legend'), 'x_vel','y_vel','z_vel');
    ...
    h_w.XLim = [t(1) t(end)];
    legend(h_w,'r','p','y', 'Location', 'northeastoutside');
    set( get(h_w,'Title'), 'String', 'Angular velocity [rad/s]' );
    %set( get(h_w,'legend'), 'String', 'roll_rate','pitch_rate','yaw_rate');
    ...
    h_u.XLim = [t(1) t(end)];
    legend(h_u,'Fz_1','Fz_2','Fz_3','Fz_4');
    set( get(h_u,'Title'), 'String', 'Fz [N]' );
    %set( get(h_u,'legend'), 'String', 'Fz_1','Fz_2','Fz_3','Fz_4' );
